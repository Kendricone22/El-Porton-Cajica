...
| 7 | `analitica-setup.sql` | `ventas_serie()` / `ventas_totales()` | ❌ **PENDIENTE** |

Mientras el 7 no se corra, la ventana de Ventas del panel muestra el aviso
amarillo y los 4 KPIs caen al cálculo viejo del navegador (respaldo
deliberado: no se rompe nada, solo no usa las funciones del servidor).
